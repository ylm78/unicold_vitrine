      ...
      <section className="relative py-32 bg-slate-950 overflow-hidden border-b border-ice-500/10">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <div className="glass-panel w-24 h-24 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <FileText className="w-12 h-12 text-ice-400" />
          </div>
          ...
          <div className="space-y-12">
            ...
            <div className="glass-panel p-8 rounded-2xl">
              <h2 className="text-3xl font-display font-bold text-white mb-6 flex items-center">
                <Building2 className="w-8 h-8 text-ice-400 mr-3" />
                Informations Légales
              </h2>
              <div className="space-y-4 text-ice-200/80">
                <div>
                  <strong className="text-white">Raison sociale :</strong> UNICOLD
                </div>
                <div>
                  <strong className="text-white">SIRET :</strong> 881 522 296 00014
                </div>
                <div>
                  <strong className="text-white">Forme juridique :</strong> Société (à compléter selon votre statut)
                </div>
                <div>
                  <strong className="text-white">Siège social :</strong> 16 Rue Pascal, 78300 Poissy, France
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel p-8 rounded-2xl">
              <h2 className="text-3xl font-display font-bold text-white mb-6 flex items-center">
                <Phone className="w-8 h-8 text-ice-400 mr-3" />
                Coordonnées
              </h2>
              <div className="space-y-4 text-ice-200/80">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <a href="mailto:devis@unicold.fr" className="hover:text-ice-300 transition block text-sm">devis@unicold.fr</a>
                    <a href="mailto:contact@unicold.fr" className="hover:text-ice-300 transition block text-sm mt-1">contact@unicold.fr</a>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="glass-panel p-8 rounded-2xl">
              ...
              <div className="space-y-4 text-ice-200/80">
                <p>
                  Ce site est hébergé par (à compléter selon votre hébergeur) :
                </p>
                <div>
                  <strong className="text-white">Hébergeur :</strong> (À compléter)
                </div>
                <div>
            ...
            <div className="glass-panel p-8 rounded-2xl">
              ...
              <p className="text-ice-200/80 leading-relaxed">
                ...
                <a href="mailto:contact@unicold.fr" className="text-ice-400 hover:text-ice-300 transition">contact@unicold.fr</a>
              </p>
            </div>
            ...
            <div className="text-center pt-8">
              <Link
                to="/"
                className="inline-flex items-center text-ice-400 hover:text-ice-300 transition"
              >
                ← Retour à l'accueil
              </Link>
            </div>
