    ...
    <div>
      ...
      <section className="relative py-32 bg-white overflow-hidden border-b border-sky-500/10">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <h1 className="font-display text-5xl md:text-6xl font-bold mb-4 text-slate-900">À Propos d'Unicold</h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div>
                <h2 className="text-3xl font-display font-bold text-slate-900 mb-6">Notre Histoire</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-20">
              <div className="glass-card p-8 rounded-2xl text-center hover-lift">
                ...
                <p className="text-slate-600/70">Produits et services de haute qualité</p>
              </div>
              <div className="glass-card p-8 rounded-2xl text-center hover-lift">
                <div className="w-16 h-16 rounded-2xl bg-sky-300/10 flex items-center justify-center mx-auto mb-6 text-sky-500">
                  <Users className="w-8 h-8" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-3">Proximité</h3>
                <p className="text-slate-600/70">Relation de confiance avec nos clients</p>
              </div>
              <div className="glass-card p-8 rounded-2xl text-center hover-lift">
                <div className="w-16 h-16 rounded-2xl bg-sky-300/10 flex items-center justify-center mx-auto mb-6 text-sky-500">
                ...
                <p className="text-slate-600/70">Solutions toujours plus performantes</p>
              </div>
            </div>
            ...
            <div className="mb-20">
              ...
              <p className="text-lg text-slate-600/70 text-center mb-12 max-w-3xl mx-auto">
            ...
            <div className="text-center">
              <Link
                to="/contact"
                className="inline-flex items-center bg-gradient-to-r from-ice-600 to-blue-600 hover:from-ice-500 hover:to-blue-500 text-slate-900 px-10 py-4 rounded-xl font-bold text-lg transition-all shadow-[0_0_20px_rgba(14,165,233,0.4)] hover:scale-105"
              >
                Nous contacter
