        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Chambres Compactes</h3>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-slate-600/70">Chambres de 3m³ à 20m³</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Groupes monoblocs silencieux</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Installation en 1-2 jours</span>
                </li>
              </ul>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Matériaux lisses et lavables</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Traçabilité des températures</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Éclairage LED adapté</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="px-10 py-5 text-slate-900 rounded-xl font-bold text-xl transition-all shadow-[0_0_30px_rgba(249,115,22,0.5)] hover:scale-105 flex items-center justify-center gap-3"
