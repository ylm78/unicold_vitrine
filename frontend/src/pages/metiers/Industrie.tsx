...
export default function Industrie() {
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Entrepôts Frigorifiques</h3>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-slate-600/70">Chambres modulaires extensibles</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Groupes frigorifiques haute puissance</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Système de monitoring à distance</span>
                </li>
              </ul>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Optimisation Énergétique</h3>
              <p className="text-slate-600/70 mb-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Groupes classe A+++</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Variateurs de vitesse (inverter)</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Jusqu'à 40% d'économie d'énergie</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Avantages */}
      <section className="py-20 bg-gradient-to-br from-white to-blue-50/20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900 mb-4">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="px-10 py-5 text-slate-900 rounded-xl font-bold text-xl transition-all shadow-[0_0_30px_rgba(59,130,246,0.5)] hover:scale-105 flex items-center justify-center gap-3"
