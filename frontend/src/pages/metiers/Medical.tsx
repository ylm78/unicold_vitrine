...
export default function Medical() {
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Précision de Température</h3>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-ice-200/70">Régulation PID haute précision</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-ice-200/70">Sondes multiples avec redondance</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-ice-200/70">Enregistrement continu des températures</span>
                </li>
              </ul>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Traçabilité & Conformité</h3>
              <p className="text-ice-200/70 mb-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-ice-200/70">Enregistrement horodaté des températures</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-ice-200/70">Rapports d'audit automatiques</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-ice-200/70">Conformité BPF et GDP</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Sécurité */}
      <section className="py-20 bg-gradient-to-br from-slate-950 to-purple-950/20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">
              Sécurité & Fiabilité
      ...
      <section className="py-20 bg-slate-950">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="px-10 py-5 text-white rounded-xl font-bold text-xl transition-all shadow-[0_0_30px_rgba(168,85,247,0.5)] hover:scale-105 flex items-center justify-center gap-3"
