          ...
          <div className="max-w-6xl mx-auto space-y-20">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                {/* Secteurs d'activité */}
                <div className="mb-8">
                  <h4 className="font-bold text-white mb-4 text-lg">Secteurs d'intervention :</h4>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex items-center space-x-2 p-3 glass-card rounded-lg">
                      <UtensilsCrossed className="w-5 h-5 text-ice-400" />
                      <span className="text-ice-200/80 text-sm">Restauration</span>
                    </div>
                    <div className="flex items-center space-x-2 p-3 glass-card rounded-lg">
                      <Building2 className="w-5 h-5 text-ice-400" />
                      <span className="text-ice-200/80 text-sm">Commerce</span>
                    </div>
                    <div className="flex items-center space-x-2 p-3 glass-card rounded-lg">
                      <Factory className="w-5 h-5 text-ice-400" />
                      <span className="text-ice-200/80 text-sm">Industrie Agroalimentaire</span>
                    </div>
                    <div className="flex items-center space-x-2 p-3 glass-card rounded-lg">
                      <Shield className="w-5 h-5 text-ice-400" />
                      <span className="text-ice-200/80 text-sm">Secteur Médical</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-ice-200/70 leading-relaxed mb-2">
                        De 0°C à +10°C, idéales pour la conservation des fruits, légumes et produits frais
                      </p>
                      <p className="text-xs text-ice-300/60">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mt-20">
              ...
              <div className="order-1 md:order-1">
                ...
                <p className="text-ice-200/80 mb-6 text-lg leading-relaxed">
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-ice-200/70">Montage par équipes certifiées QualiFroid</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <span className="text-ice-200/70">Mise en service et réglages optimaux</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <span className="text-ice-200/70">Formation du personnel aux bonnes pratiques</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <span className="text-ice-200/70">Conformité HACCP garantie</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-20">
              <div className="glass-card p-8 rounded-2xl hover-lift border-2 border-red-500/30 relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Maintenance & Dépannage 24/7</h3>
                <p className="text-ice-200/70 leading-relaxed mb-3">
                ...
                <ul className="space-y-2 text-sm text-ice-200/70">
            ...
            <div className="mt-20 glass-panel p-10 rounded-2xl border-ice-500/30">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-bold text-white mb-1">Réduction des coûts</h4>
                        <p className="text-ice-200/70 text-sm">Jusqu'à 30% d'économie sur la consommation énergétique grâce à l'optimisation régulière</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <Shield className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-bold text-white mb-1">Garantie de continuité</h4>
                        <p className="text-ice-200/70 text-sm">Intervention prioritaire et pièces détachées en stock pour vos équipements</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-bold text-white mb-1">Conformité réglementaire</h4>
                        <p className="text-ice-200/70 text-sm">Traçabilité des interventions et respect des normes HACCP</p>
                      </div>
                    </div>
                  </div>
                  <Link
                    to="/contact"
                    className="inline-flex items-center mt-6 bg-accent hover:bg-accent-hover text-white px-8 py-3 rounded-xl font-bold transition-all shadow-[0_0_25px_rgba(249,115,22,0.5)] hover:scale-105"
                ...
                <div className="glass-card p-8 rounded-xl">
                  <h3 className="text-xl font-bold text-white mb-6">Contrats disponibles :</h3>
                  <div className="space-y-4">
                    <div className="border-l-4 border-ice-500 pl-4">
                      <h4 className="font-bold text-white mb-2">Contrat Essentiel</h4>
                      <p className="text-ice-200/70 text-sm mb-2">2 visites annuelles + dépannage</p>
                      <p className="text-ice-300 font-semibold">À partir de 800€/an</p>
                    </div>
                    <div className="border-l-4 border-emerald-500 pl-4">
                      <h4 className="font-bold text-white mb-2">Contrat Premium</h4>
                      <p className="text-ice-200/70 text-sm mb-2">4 visites annuelles + dépannage 24/7 + optimisation</p>
                      <p className="text-ice-300 font-semibold">À partir de 1 500€/an</p>
                    </div>
                    <div className="border-l-4 border-accent pl-4">
                      <h4 className="font-bold text-white mb-2">Contrat Entreprise</h4>
                      <p className="text-ice-200/70 text-sm mb-2">Sur-mesure pour parcs d'équipements</p>
                      <p className="text-ice-300 font-semibold">Devis personnalisé</p>
                    </div>
                  </div>
                </div>
              </div>
