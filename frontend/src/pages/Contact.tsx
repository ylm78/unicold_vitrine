        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="glass-panel p-8 rounded-2xl">
              <h2 className="text-2xl font-display font-bold text-slate-900 mb-6">Informations de Contact</h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-4 glass-card rounded-xl hover:bg-white/5 transition">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 mb-2">Téléphone</div>
                    <div className="space-y-2">
                      <div>
                        <a href="tel:+33172541360" className="text-sky-500 hover:text-slate-700 hover:underline transition block text-lg">
                          +33 1 72 54 13 60
                        </a>
                        <span className="text-xs text-emerald-400 font-semibold">(Numéro gratuit)</span>
                      </div>
                      <div>
                        <a href="tel:+33662649421" className="text-sky-500 hover:text-slate-700 hover:underline transition block text-lg">
                          +33 6 62 64 94 21
                        </a>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <a href="mailto:devis@unicold.fr" className="text-sky-500 hover:text-slate-700 hover:underline transition block">devis@unicold.fr</a>
                      </div>
                      <div>
                        <span className="text-xs text-slate-700/60 block mb-1">Pour toute autre demande :</span>
                        <a href="mailto:contact@unicold.fr" className="text-sky-500 hover:text-slate-700 hover:underline transition block">contact@unicold.fr</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="flex items-start space-x-4 p-4 glass-card rounded-xl hover:bg-white/5 transition">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 mb-2">Siège Social</div>
                    <div className="text-slate-600/70">16 Rue Pascal, 78300 Poissy, France</div>
                  </div>
                </div>
              </div>
              <div className="mt-8 pt-6 border-t border-sky-200">
                <Link
                  to="/devis"
                  className="inline-flex items-center justify-center w-full bg-accent hover:bg-accent-hover text-slate-900 px-6 py-4 rounded-xl font-bold text-lg transition-all shadow-[0_0_25px_rgba(249,115,22,0.5)] hover:shadow-[0_0_35px_rgba(249,115,22,0.7)] hover:scale-105"
                >
                  Demander un devis
                </Link>
              </div>
            ...
            <div className="glass-panel p-8 rounded-2xl">
              <h2 className="text-2xl font-display font-bold text-slate-900 mb-6">Horaires & Disponibilité</h2>
              <div className="space-y-6">
                <div className="p-4 glass-card rounded-xl">
                  <h3 className="font-semibold text-slate-900 mb-2">Horaires d'ouverture</h3>
                  <div className="text-slate-600/70 space-y-1 text-sm">
                ...
                <div className="p-4 glass-card rounded-xl bg-red-500/10 border border-red-500/20">
                  <h3 className="font-semibold text-slate-900 mb-2">Dépannage 24/7</h3>
                ...
                <div className="p-4 glass-card rounded-xl bg-emerald-500/10 border border-emerald-500/20">
                  <h3 className="font-semibold text-slate-900 mb-2">Réponse rapide</h3>
          ...
          {/* Google Maps */}
          <div className="mt-16">
            <h2 className="text-3xl font-display font-bold text-slate-900 mb-8 text-center">Nos Implantations</h2>
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="glass-card p-6 rounded-xl">
                <h3 className="font-bold text-slate-900 mb-2">Siège Social</h3>
                <p className="text-slate-600/70 text-sm mb-4">16 Rue Pascal<br />78300 Poissy</p>
                <a 
                  href="https://www.google.com/maps/search/16+Rue+Pascal+78300+Poissy" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-sky-500 hover:text-slate-700 text-sm flex items-center transition"
                >
              ...
              <div className="glass-card p-6 rounded-xl">
                <h3 className="font-bold text-slate-900 mb-2">Showroom</h3>
                <p className="text-slate-600/70 text-sm mb-4">138 Les Berges de Seine<br />91830 Le Coudray-Montceaux</p>
                <a 
              ...
              <div className="glass-card p-6 rounded-xl">
                <h3 className="font-bold text-slate-900 mb-2">Entrepôt</h3>
                <p className="text-slate-600/70 text-sm mb-4">ZA de la Rabette<br />28100 Dreux</p>
                <a 
