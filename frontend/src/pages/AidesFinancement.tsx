        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="glass-panel p-10 rounded-2xl border-2 border-emerald-500/30">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600/80 text-lg leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Certificats d'Économies d'Énergie (CEE)</h3>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <span className="text-slate-900 font-semibold">Éligibilité :</span>
                    <span className="text-slate-600/70"> Groupes frigorifiques classe A+++, variateurs de vitesse</span>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <div>
                    ...
                    <span className="text-slate-600/70"> Jusqu'à 20-30% du coût d'installation</span>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <div>
                    <span className="text-slate-900 font-semibold">Délai :</span>
                    <span className="text-slate-600/70"> Dossier traité sous 2-4 semaines</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Suramortissement Fiscal</h3>
              <p className="text-slate-600/70 mb-6">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <span className="text-slate-900 font-semibold">Éligibilité :</span>
                    <span className="text-slate-600/70"> Équipements classe A+++</span>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <div>
                    <span className="text-slate-900 font-semibold">Avantage :</span>
                    <span className="text-slate-600/70"> Amortissement accéléré, réduction d'impôt</span>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <div>
                    <span className="text-slate-900 font-semibold">Application :</span>
                    <span className="text-slate-600/70"> Déclaration fiscale annuelle</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Aides Régionales</h3>
              <p className="text-slate-600/70 mb-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Aides variables selon les régions</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Cumulables avec les CEE</span>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Financement Classique</h3>
              <p className="text-slate-600/70 mb-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Crédit-bail pour étaler les paiements</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-slate-600/70">Taux compétitifs, devis personnalisé</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="glass-panel p-10 rounded-2xl border-2 border-emerald-500/30">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600/80 text-lg mb-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">Évaluation de l'éligibilité</h4>
              ...
              <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">Montage du dossier CEE</h4>
                  <p className="text-slate-600/70 text-sm">
              ...
              <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">Suivi administratif</h4>
                  <p className="text-slate-600/70 text-sm">
              ...
              <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">Conseil en financement</h4>
                  <p className="text-slate-600/70 text-sm">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="px-10 py-5 text-slate-900 rounded-xl font-bold text-xl transition-all shadow-[0_0_30px_rgba(16,185,129,0.5)] hover:scale-105 flex items-center justify-center gap-3"
