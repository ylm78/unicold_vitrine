...
export default function Depannage() {
  return (
    <div>
      ...
      <section className="relative py-32 bg-gradient-to-br from-red-950 via-slate-950 to-red-950 overflow-hidden border-b border-red-500/20">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-ice-100/80 max-w-3xl mx-auto mb-10">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="glass-panel p-6 rounded-xl text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Île-de-France</h3>
            ...
            <div className="glass-panel p-6 rounded-xl text-center">
              <MapPin className="w-12 h-12 text-red-400 mx-auto mb-4" />
              <h3 className="text-xl font-bold text-white mb-2">Centre-Val de Loire</h3>
              <p className="text-ice-200/70 text-sm mb-3">
      ...
      {/* Tarifs et Devis */}
      <section className="py-20 bg-gradient-to-br from-slate-950 to-red-950/20">
          ...
          <div className="glass-panel p-10 rounded-2xl border-2 border-red-500/30">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                ...
                <div>
                  <h3 className="font-bold text-white mb-1">Déplacement</h3>
              ...
              <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-bold text-white mb-1">Diagnostic</h3>
                  <p className="text-ice-200/70 text-sm">
              ...
              <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-bold text-white mb-1">Intervention</h3>
                  <p className="text-ice-200/70 text-sm">
              ...
              <div className="flex items-start space-x-4 p-4 glass-card rounded-xl">
                <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-bold text-white mb-1">Pièces détachées</h3>
                  <p className="text-ice-200/70 text-sm">
            ...
            <div className="text-center">
              <p className="text-ice-200/80 mb-6">
      ...
      {/* CTA Final */}
      <section className="py-20 bg-gradient-to-br from-red-950/50 to-slate-950">
