      ...
      <section className="relative py-32 bg-slate-950 overflow-hidden border-b border-ice-500/10">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <div className="glass-panel w-24 h-24 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Lightbulb className="w-12 h-12 text-ice-400" />
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <div className="glass-card p-8 rounded-2xl border-l-4 border-ice-400">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                  <Zap className="w-8 h-8 text-ice-400 mr-3" />
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      <strong className="text-white">Puissance :</strong>
                      <p className="text-ice-200/70">65W LED (équivalent à 200W halogène)</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-white">Économie d'énergie :</strong>
                      <p className="text-ice-200/70">Jusqu'à 80% de réduction par rapport aux solutions classiques</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-white">Luminosité :</strong>
                      <p className="text-ice-200/70">6500 lumens, éclairage uniforme et puissant</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="glass-card p-8 rounded-2xl border-l-4 border-ice-500">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                  <Snowflake className="w-8 h-8 text-ice-400 mr-3" />
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-white">Température :</strong>
                      <p className="text-ice-200/70">Fonctionnement garanti de -30°C à +50°C</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-white">Protection :</strong>
                      <p className="text-ice-200/70">IP65 - Résistant à l'eau et à l'humidité</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-white">Durée de vie :</strong>
                      <p className="text-ice-200/70">50 000 heures minimum (plus de 10 ans d'utilisation)</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="glass-card p-6 rounded-xl hover-lift">
                  ...
                  <h4 className="font-bold text-white mb-2">Basse Consommation</h4>
                  <p className="text-ice-200/70">Réduction significative de votre facture d'électricité</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Droplet className="w-10 h-10 text-ice-400 mb-4" />
                  <h4 className="font-bold text-white mb-2">Résistant à l'Humidité</h4>
                  <p className="text-ice-200/70">Protection IP65, parfait pour les environnements humides</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Snowflake className="w-10 h-10 text-ice-400 mb-4" />
                  <h4 className="font-bold text-white mb-2">Fonctionne au Froid</h4>
                  <p className="text-ice-200/70">Démarrage instantané même à -30°C</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Shield className="w-10 h-10 text-ice-400 mb-4" />
                  <h4 className="font-bold text-white mb-2">Robuste & Durable</h4>
                  <p className="text-ice-200/70">Construction en acier inoxydable, résistant aux chocs</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Lightbulb className="w-10 h-10 text-ice-400 mb-4" />
                  <h4 className="font-bold text-white mb-2">Éclairage Uniforme</h4>
                  <p className="text-ice-200/70">Pas d'ombres, éclairage optimal pour le travail</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <CheckCircle className="w-10 h-10 text-ice-400 mb-4" />
                  <h4 className="font-bold text-white mb-2">Maintenance Réduite</h4>
                  <p className="text-ice-200/70">Durée de vie exceptionnelle, moins d'interventions</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-16 glass-panel p-8 rounded-2xl">
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="font-bold text-white mb-4">Caractéristiques Électriques</h4>
                  <ul className="space-y-2 text-ice-200/70">
                    <li>• Puissance : 65W</li>
                ...
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="font-bold text-white mb-4">Caractéristiques Physiques</h4>
                  <ul className="space-y-2 text-ice-200/70">
            ...
            <div className="glass-panel p-10 rounded-2xl mb-16 border-ice-500/30">
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="text-lg font-bold text-white mb-3">Unité</h4>
                  <p className="text-3xl font-bold text-white mb-2"><span className="text-ice-300">85€</span></p>
                  <p className="text-ice-200/70 text-sm">Luminaire LED 65W seul</p>
                </div>
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="text-lg font-bold text-white mb-3">Pack 5 unités</h4>
                  <p className="text-3xl font-bold text-white mb-2"><span className="text-ice-300">395€</span></p>
                  <p className="text-ice-200/70 text-sm">Soit 79€ l'unité (-7%)</p>
                </div>
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="text-lg font-bold text-white mb-3">Pack 10 unités</h4>
                  <p className="text-3xl font-bold text-white mb-2"><span className="text-ice-300">750€</span></p>
                  <p className="text-ice-200/70 text-sm">Soit 75€ l'unité (-12%)</p>
                </div>
              </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="glass-card p-6 rounded-xl border-l-4 border-ice-500">
                  <h4 className="font-bold text-white mb-3 text-lg">Installation Simple</h4>
                  <p className="text-ice-200/70">Fixation au plafond ou sur les parois, raccordement électrique standard. Nos équipes peuvent assurer l'installation complète.</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-ice-500">
                  <h4 className="font-bold text-white mb-3 text-lg">Recommandations</h4>
                  <p className="text-ice-200/70">1 luminaire pour 8-10m² de surface. Espacement recommandé : 2-3 mètres entre chaque luminaire.</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-ice-500">
                  <h4 className="font-bold text-white mb-3 text-lg">Compatible Toutes Températures</h4>
                  <p className="text-ice-200/70">Fonctionne parfaitement en chambre froide positive (0°C à +10°C) et négative (-18°C à -25°C).</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-ice-500">
                  <h4 className="font-bold text-white mb-3 text-lg">Garantie 3 Ans</h4>
                  <p className="text-ice-200/70">Garantie constructeur 3 ans pièces et main d'œuvre. Service après-vente disponible.</p>
                </div>
              </div>
            </div>
          </div>
