            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <div className="bg-gradient-to-br from-unicold-blue-50 to-white p-8 rounded-2xl border border-unicold-blue-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <Zap className="w-8 h-8 text-unicold-blue-600 mr-3" />
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      <strong className="text-gray-900">Puissance :</strong>
                      <p className="text-gray-600">65W LED (équivalent à 200W halogène)</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      ...
                      <p className="text-gray-600">Jusqu'à 80% de réduction par rapport aux solutions classiques</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-gray-900">Luminosité :</strong>
                      <p className="text-gray-600">6500 lumens, éclairage uniforme et puissant</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gradient-to-br from-unicold-blue-50 to-white p-8 rounded-2xl border border-unicold-blue-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  <Snowflake className="w-8 h-8 text-unicold-blue-600 mr-3" />
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-gray-900">Température :</strong>
                      <p className="text-gray-600">Fonctionnement garanti de -30°C à +50°C</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      ...
                      <p className="text-gray-600">IP65 - Résistant à l'eau et à l'humidité</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-gray-900">Durée de vie :</strong>
                      <p className="text-gray-600">50 000 heures minimum (plus de 10 ans d'utilisation)</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl border border-gray-200 hover-lift">
                  ...
                  <h4 className="font-bold text-gray-900 mb-2">Basse Consommation</h4>
                  <p className="text-gray-600">Réduction significative de votre facture d'électricité</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 hover-lift">
                  <Droplet className="w-10 h-10 text-unicold-blue-600 mb-4" />
                  <h4 className="font-bold text-gray-900 mb-2">Résistant à l'Humidité</h4>
                  <p className="text-gray-600">Protection IP65, parfait pour les environnements humides</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 hover-lift">
                  <Snowflake className="w-10 h-10 text-unicold-blue-600 mb-4" />
                  <h4 className="font-bold text-gray-900 mb-2">Fonctionne au Froid</h4>
                  <p className="text-gray-600">Démarrage instantané même à -30°C</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 hover-lift">
                  <Shield className="w-10 h-10 text-unicold-blue-600 mb-4" />
                  <h4 className="font-bold text-gray-900 mb-2">Robuste & Durable</h4>
                  <p className="text-gray-600">Construction en acier inoxydable, résistant aux chocs</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 hover-lift">
                  <Lightbulb className="w-10 h-10 text-unicold-blue-600 mb-4" />
                  <h4 className="font-bold text-gray-900 mb-2">Éclairage Uniforme</h4>
                  <p className="text-gray-600">Pas d'ombres, éclairage optimal pour le travail</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 hover-lift">
                  <CheckCircle className="w-10 h-10 text-unicold-blue-600 mb-4" />
                  <h4 className="font-bold text-gray-900 mb-2">Maintenance Réduite</h4>
                  <p className="text-gray-600">Durée de vie exceptionnelle, moins d'interventions</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-16 bg-gray-50 p-8 rounded-2xl">
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                <div className="bg-white p-6 rounded-xl">
                  <h4 className="font-bold text-gray-900 mb-4">Caractéristiques Électriques</h4>
                ...
                <div className="bg-white p-6 rounded-xl">
                  <h4 className="font-bold text-gray-900 mb-4">Caractéristiques Physiques</h4>
                  <ul className="space-y-2 text-gray-600">
            ...
            <div className="bg-gradient-to-br from-unicold-blue-600 to-unicold-blue-700 text-white p-10 rounded-2xl mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                  <h4 className="text-lg font-bold mb-3">Unité</h4>
                  <p className="text-3xl font-bold mb-2"><span className="text-unicold-blue-200">85€</span></p>
                  <p className="text-unicold-blue-100 text-sm">Luminaire LED 65W seul</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                  <h4 className="text-lg font-bold mb-3">Pack 5 unités</h4>
                  <p className="text-3xl font-bold mb-2"><span className="text-unicold-blue-200">395€</span></p>
                  <p className="text-unicold-blue-100 text-sm">Soit 79€ l'unité (-7%)</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                  <h4 className="text-lg font-bold mb-3">Pack 10 unités</h4>
                  <p className="text-3xl font-bold mb-2"><span className="text-unicold-blue-200">750€</span></p>
                  <p className="text-unicold-blue-100 text-sm">Soit 75€ l'unité (-12%)</p>
                </div>
              </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-xl border-l-4 border-unicold-blue-600">
                  <h4 className="font-bold text-gray-900 mb-3 text-lg">Installation Simple</h4>
                  <p className="text-gray-600">Fixation au plafond ou sur les parois, raccordement électrique standard. Nos équipes peuvent assurer l'installation complète.</p>
                </div>
                <div className="bg-white p-6 rounded-xl border-l-4 border-unicold-blue-600">
                  <h4 className="font-bold text-gray-900 mb-3 text-lg">Recommandations</h4>
                  <p className="text-gray-600">1 luminaire pour 8-10m² de surface. Espacement recommandé : 2-3 mètres entre chaque luminaire.</p>
                </div>
                <div className="bg-white p-6 rounded-xl border-l-4 border-unicold-blue-600">
                  <h4 className="font-bold text-gray-900 mb-3 text-lg">Compatible Toutes Températures</h4>
                  <p className="text-gray-600">Fonctionne parfaitement en chambre froide positive (0°C à +10°C) et négative (-18°C à -25°C).</p>
                </div>
                <div className="bg-white p-6 rounded-xl border-l-4 border-unicold-blue-600">
                  <h4 className="font-bold text-gray-900 mb-3 text-lg">Garantie 3 Ans</h4>
                  <p className="text-gray-600">Garantie constructeur 3 ans pièces et main d'œuvre. Service après-vente disponible.</p>
                </div>
              </div>
            </div>
          </div>
