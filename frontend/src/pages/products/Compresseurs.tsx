      ...
      <section className="relative py-32 bg-white overflow-hidden border-b border-sky-500/10">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <div className="glass-panel w-24 h-24 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Snowflake className="w-12 h-12 text-sky-500" />
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <p className="text-lg text-slate-600/80 leading-relaxed mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <div className="glass-card p-8 rounded-2xl border-l-4 border-sky-300">
                <div className="flex items-center mb-6">
                  <div className="w-16 h-16 rounded-2xl bg-sky-300/10 flex items-center justify-center mr-4 text-sky-500">
                    <Zap className="w-8 h-8" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-900">Positif (0°C à +10°C)</h3>
                </div>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Puissances :</strong>
                      <p className="text-slate-600/70">De 500W à 15kW selon volume</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Applications :</strong>
                      <p className="text-slate-600/70">Conservation produits frais, restauration</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Fluides frigorigènes :</strong>
                      <p className="text-slate-600/70">R134a, R404A, R407C (écologiques)</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="glass-card p-8 rounded-2xl border-l-4 border-sky-500">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900">Négatif (-18°C à -25°C)</h3>
                </div>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Puissances :</strong>
                      <p className="text-slate-600/70">De 1kW à 20kW selon volume</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Applications :</strong>
                      <p className="text-slate-600/70">Congélation, conservation longue durée</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Technologie :</strong>
                      <p className="text-slate-600/70">Compresseurs scroll ou piston haute performance</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="glass-card p-6 rounded-xl hover-lift">
                  ...
                  <h4 className="font-bold text-slate-900 mb-2">Haute Efficacité Énergétique</h4>
                  <p className="text-slate-600/70">Classe A+++, réduction jusqu'à 30% de consommation électrique</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Settings className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Régulation Précise</h4>
                  <p className="text-slate-600/70">Thermostat électronique avec affichage digital, ±0,5°C</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Droplet className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Dégivrage Automatique</h4>
                  <p className="text-slate-600/70">Système de dégivrage par gaz chaud ou électrique</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Gauge className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Protection Intégrée</h4>
                  <p className="text-slate-600/70">Sécurité haute/basse pression, protection moteur</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Snowflake className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Installation Flexible</h4>
                  <p className="text-slate-600/70">Monobloc ou split, intérieur ou extérieur</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <CheckCircle className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Garantie 2 Ans</h4>
                  <p className="text-slate-600/70">Garantie constructeur + service après-vente</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel p-10 rounded-2xl mb-16 border-sky-500/30">
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="text-lg font-bold text-slate-900 mb-3">Petit Volume</h4>
                  <p className="text-2xl font-bold text-slate-900 mb-2">À partir de <span className="text-slate-700">1 200€</span></p>
                  <p className="text-slate-600/70 text-sm">Jusqu'à 10m³, positif</p>
                </div>
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="text-lg font-bold text-slate-900 mb-3">Volume Moyen</h4>
                  <p className="text-2xl font-bold text-slate-900 mb-2">À partir de <span className="text-slate-700">2 500€</span></p>
                  <p className="text-slate-600/70 text-sm">10-30m³, positif ou négatif</p>
                </div>
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="text-lg font-bold text-slate-900 mb-3">Grand Volume</h4>
                  <p className="text-2xl font-bold text-slate-900 mb-2">À partir de <span className="text-slate-700">4 500€</span></p>
                  <p className="text-slate-600/70 text-sm">30m³+, haute performance</p>
                </div>
              </div>
            ...
            <div className="mb-16 glass-panel p-8 rounded-2xl">
              ...
              <div className="space-y-6 max-w-4xl mx-auto">
                <div className="glass-card p-6 rounded-xl border-l-4 border-sky-500">
                  <h4 className="font-bold text-slate-900 mb-3 text-lg">1. Volume de la chambre froide</h4>
                  <p className="text-slate-600/70">Le volume détermine la puissance nécessaire. Comptez environ 100W par m³ pour le positif, 150W par m³ pour le négatif.</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-sky-500">
                  <h4 className="font-bold text-slate-900 mb-3 text-lg">2. Température de consigne</h4>
                  <p className="text-slate-600/70">Positif (0°C à +10°C) ou négatif (-18°C à -25°C) ? Cela détermine le type de compresseur nécessaire.</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-sky-500">
                  <h4 className="font-bold text-slate-900 mb-3 text-lg">3. Emplacement d'installation</h4>
                  <p className="text-slate-600/70">Intérieur ou extérieur ? Monobloc ou split ? Nos experts vous conseillent selon vos contraintes.</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-sky-500">
                  <h4 className="font-bold text-slate-900 mb-3 text-lg">4. Fréquence d'ouverture</h4>
                  <p className="text-slate-600/70">Un usage intensif nécessite une puissance supérieure pour maintenir la température.</p>
                </div>
              </div>
            </div>
          </div>
