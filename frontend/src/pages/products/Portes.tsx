      ...
      <section className="relative py-32 bg-white overflow-hidden border-b border-sky-500/10">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <div className="glass-panel w-24 h-24 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <DoorOpen className="w-12 h-12 text-sky-500" />
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <div className="glass-card p-8 rounded-2xl border-l-4 border-sky-300">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900">Portes Coulissantes</h3>
                </div>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Avantages :</strong>
                      <p className="text-slate-600/70">Gain d'espace, ouverture facile, idéal pour passages fréquents</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      ...
                      <p className="text-slate-600/70">Largeur : 800mm à 2000mm | Hauteur : 2000mm à 2500mm</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Options :</strong>
                      <p className="text-slate-600/70">Vitre, ouverture automatique, serrure</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="glass-card p-8 rounded-2xl border-l-4 border-sky-500">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900">Portes Battantes</h3>
                </div>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Avantages :</strong>
                      <p className="text-slate-600/70">Étanchéité maximale, robustesse, installation simple</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Dimensions :</strong>
                      <p className="text-slate-600/70">Largeur : 600mm à 1200mm | Hauteur : 2000mm à 2500mm</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 flex-shrink-0 mt-1" />
                    <div>
                      <strong className="text-slate-900">Options :</strong>
                      <p className="text-slate-600/70">Simple ou double battant, vitre, poignée ergonomique</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="glass-card p-6 rounded-xl hover-lift">
                  ...
                  <h4 className="font-bold text-slate-900 mb-2">Isolation Renforcée</h4>
                  <p className="text-slate-600/70">Coefficient U ≤ 0,8 W/(m².K) - Performance exceptionnelle</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Lock className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Étanchéité Parfaite</h4>
                  <p className="text-slate-600/70">Joints magnétiques double lèvre, résistants aux variations de température</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Gauge className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Résistance Mécanique</h4>
                  <p className="text-slate-600/70">Structure en acier galvanisé, résistant aux chocs et à la corrosion</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <CheckCircle className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Fermeture Automatique</h4>
                  <p className="text-slate-600/70">Système de fermeture assistée pour économie d'énergie</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <DoorOpen className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Ouverture Facile</h4>
                  <p className="text-slate-600/70">Poignées ergonomiques, même avec gants de protection</p>
                </div>
                <div className="glass-card p-6 rounded-xl hover-lift">
                  <Shield className="w-10 h-10 text-sky-500 mb-4" />
                  <h4 className="font-bold text-slate-900 mb-2">Sécurité</h4>
                  <p className="text-slate-600/70">Serrure intérieure/extérieure, ouverture de secours</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel p-10 rounded-2xl mb-16 border-sky-500/30">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="text-xl font-bold text-slate-900 mb-4">Porte Coulissante Standard</h4>
                  <p className="text-3xl font-bold text-slate-900 mb-2">À partir de <span className="text-slate-700">450€</span></p>
                  <p className="text-slate-600/70 text-sm mb-4">800x2000mm, sans vitre</p>
                  <ul className="text-left text-sm text-slate-600/70 space-y-2">
                ...
                <div className="glass-card p-6 rounded-xl">
                  <h4 className="text-xl font-bold text-slate-900 mb-4">Porte Battante Standard</h4>
                  <p className="text-3xl font-bold text-slate-900 mb-2">À partir de <span className="text-slate-700">380€</span></p>
                  <p className="text-slate-600/70 text-sm mb-4">800x2000mm, simple battant</p>
                  <ul className="text-left text-sm text-slate-600/70 space-y-2">
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="glass-card p-6 rounded-xl border-l-4 border-sky-500">
                  <h4 className="font-bold text-slate-900 mb-3 text-lg">Vitre de Visite</h4>
                  <p className="text-slate-600/70">Plexiglas renforcé, permet de voir l'intérieur sans ouvrir la porte</p>
                  <p className="text-slate-700 font-semibold mt-2">+120€ à +150€</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-sky-500">
                  <h4 className="font-bold text-slate-900 mb-3 text-lg">Ouverture Automatique</h4>
                  <p className="text-slate-600/70">Détecteur de présence, ouverture/fermeture automatique</p>
                  <p className="text-slate-700 font-semibold mt-2">+300€ à +500€</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-sky-500">
                  <h4 className="font-bold text-slate-900 mb-3 text-lg">Serrure Renforcée</h4>
                  <p className="text-slate-600/70">Sécurité renforcée avec serrure multipoints</p>
                  <p className="text-slate-700 font-semibold mt-2">+80€ à +120€</p>
                </div>
                <div className="glass-card p-6 rounded-xl border-l-4 border-sky-500">
                  <h4 className="font-bold text-slate-900 mb-3 text-lg">Poignée Ergonomique</h4>
                  <p className="text-slate-600/70">Poignée grande taille, facile à saisir même avec gants</p>
                  <p className="text-slate-700 font-semibold mt-2">+50€</p>
                </div>
              </div>
            </div>
          </div>
