    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          >
            <Snowflake className="h-6 w-6 md:h-8 md:w-8 text-sky-500 group-hover:rotate-180 transition-transform duration-700" />
            <img
              src={logo}
              alt="Unicold logo"
              className="h-8 md:h-10 w-auto object-contain"
            />
            <span className="font-display font-bold text-lg md:text-2xl tracking-wider text-slate-900">
              UNI<span className="text-sky-500">COLD</span>
            </span>
          </Link>
          ...
          <button
            ...
            className="xl:hidden inline-flex items-center justify-center p-2 rounded-md text-slate-700 hover:text-sky-600 hover:bg-sky-50 focus:outline-none"
          >
